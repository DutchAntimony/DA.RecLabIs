...
public class DateOnlyGuardTests
{
    private readonly DateOnly _date = new(2023, 10, 1);
    private readonly DateOnly _earlier = new(2023, 9, 30);
    private readonly DateOnly _later = new(2023, 10, 2);
